...
if __name__ == '__main__':
    ...
    parser.add_argument('--ver', choices=['v1', 'v2', 'v3', 'v4'], default='v1')
    parser.add_argument('--name', default=utils.get_time_str())
    # parser.add_argument('--name', default='20231213145603')
    parser.add_argument('--stock_code', nargs='+', default='0')
    ...
    parser.add_argument('--start_date', default='20221212')
    parser.add_argument('--end_date', default='20231212')
    ...
    value_network_name = f'{args.name}_{args.rl_method}_{args.net}_value.pt'
    policy_network_name = f'{args.name}_{args.rl_method}_{args.net}_policy.pt'
    ...
    from learner import ReinforcementLearner, DQNLearner, \
    ...
    for stock_code in args.stock_code:
        ...
        chart_data, training_data = data_manager.load_data(
            stock_code, args.start_date, args.end_date)
