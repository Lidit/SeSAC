...
print("standardization score1:", score1)
print("standardization score2:", score2)
print("standardization score3:", score3)
print("standardization mean", score_mean)
print("standardization standard deviation: ", score_std)